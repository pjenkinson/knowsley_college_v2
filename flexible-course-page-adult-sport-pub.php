<?php
/**
* Template Name: Flexible Course Page - Adult (Sport)
*/
get_header(); ?>
...
// Seperate Query for Sport and Public Services 
...
$sql = 			"SELECT DISTINCT id,
          ...
          AND level != 'Level 1'"/* Level 1 Courses not included for Adults */;
...
// Main query for Adult Vocational Courses
