...
class Mega_Menu_Custom_Icon {
	...
	public function enqueue_admin_scripts() {
        ...
        wp_enqueue_style( 'megamenu-custom-icon-admin', plugins_url( 'css/admin.css' , __FILE__ ), false, MEGAMENU_PRO_VERSION );

		wp_enqueue_media();

        wp_enqueue_script( 'megamenu-custom-icon', plugins_url( 'js/admin.js' , __FILE__ ), array('jquery'), MEGAMENU_PRO_VERSION );

		$params = array( 
			'file_frame_title' => __("Choose custom icon", "megamenupro")
		);

		wp_localize_script( 'megamenu-custom-icon', 'megamenu_custom_icon', $params );
	}
