...
$mail->Username = 'applications@knowsleycollege.ac.uk';                 // SMTP username
$mail->Password = 'Appl1cat10n5';                          // SMTP password
$mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
$mail->Port = 587;                                    // TCP port to connect to

$mail->setFrom('applications@knowsleycollege.ac.uk', 'Knowsley Community College');
$mail->addAddress('pjenkinsonmail@gmail.com', 'Paul Jenkinson');     // Add a recipient
...
*/
	...
	<div class="the-content">
		...
		<p>You will soon be contacted by a member of the KCC team to invite you to an interview. If you have any questions in the meantime, please call our Learner Services Department on <a href="tel:01514814630">0151 481 4630</a>.</p>
